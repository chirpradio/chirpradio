...
class ModelsTestCase(unittest.TestCase):
    ...
    def testAlbum(self):
        ...
        self.assertEqual(u'djdb/a:3039', models.Album.get_key(12345))
        ...
        self.assertEqual(models.Album.get_key(12345), alb.key().name())
        ...
        alb = models.Album(title='test album',
                           ...
                           num_tracks=44)
        # Check that the correct key is automatically assigned.
        self.assertEqual(models.Album.get_key(54321), alb.key().name())
        # Check the artist_name property.
    ...
    def testAlbumSortedTracks(self):
