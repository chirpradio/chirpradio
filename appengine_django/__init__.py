...
def LoadSdk():
  ...
  try:
    ...
    EXTRA_PATHS = [
        ...
        os.path.join(SDK_PATH, 'lib', 'cherrypy'),
        os.path.join(SDK_PATH, 'lib', 'concurrent'),
        ...
        os.path.join(SDK_PATH, 'lib', 'jinja2-2.6'),
        os.path.join(SDK_PATH, 'lib', 'markupsafe-0.15'),
        os.path.join(SDK_PATH, 'lib', 'mox'),
        ...
        os.path.join(SDK_PATH, 'lib', 'setuptools-0.6c11'),
        os.path.join(SDK_PATH, 'lib', 'simplejson'),
        os.path.join(SDK_PATH, 'lib', 'sqlcmd'),
        os.path.join(SDK_PATH, 'lib', 'webapp2-2.5.2'),
        os.path.join(SDK_PATH, 'lib', 'webob-1.1.1'),
        os.path.join(SDK_PATH, 'lib', 'yaml-3.10'),
    ]
